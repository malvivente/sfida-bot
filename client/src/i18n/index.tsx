...
export const translations: Translations = {
  ...
  'split.jackpotActive': { it: 'ATTIVO (+20% BONUS)', en: 'ACTIVE (+20% BONUS)' },
  'split.jackpotCharging': { it: 'IN CARICA (< 5 GRAM)', en: 'CHARGING (< 5 GRAM)' },
  ...
  'rules.ssRule': { it: 'Dilemma del Prigioniero rivisitato: 5 secondi per scegliere in segreto tra SPLIT (Coopera) o STEAL (Tradisci). Se entrambi fate Split, recuperate la puntata + 20% Jackpot della Fiducia. Se uno ruba e l\'altro coopera, chi ruba vince tutto! Se entrambi tradite (Doppio Tradimento), perdete entrambi: il piatto alimenta per il 50% il Jackpot della Fiducia.', en: 'Revisited Prisoner\'s Dilemma: 5 seconds to secretly choose SPLIT (Cooperate) or STEAL (Betray). If both Split, full wager refund + 20% Trust Jackpot bonus. If one steals and the other cooperates, the thief takes all! If both Steal (Double Betrayal), both lose: 50% feeds the Trust Jackpot.' },
